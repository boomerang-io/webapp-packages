  ...
  })(
    {
        ...
        function(t, e, n) {
          ...
          if (w[v] && x.xhrWrappable) {
            ...
            L.on(u, r),
              ...
              L.on(d, o),
              L.on(p, o),
              L.buffer([u, d, "xhr-done", "xhr-resolved"]),
              R.buffer([u]),
              ...
              E.buffer(["newURL"]),
              g.buffer([u]),
              b.buffer(["propagate", l, p, "executor-err", "resolve" + s]),
              S.buffer([u, "no-" + u]),
      ...
      9: [
        function(t, e, n) {
          function r(t) {
            function e() {
              c.emit("jsonp-end", [], l), t.removeEventListener("load", e, !1), t.removeEventListener("error", n, !1);
            }
            function n() {
              c.emit("jsonp-error", [], l),
                c.emit("jsonp-end", [], l),
...
NREUM.info = {
  beacon: "bam.nr-data.net",
  errorBeacon: "bam.nr-data.net",
  licenseKey: window._SERVER_DATA.NEW_RELIC_BROWSER_KEY,
  applicationID: window._SERVER_DATA.NEW_RELIC_BROWSER_ID,
  sa: 1
};
